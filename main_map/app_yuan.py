...
mapbox_access_token = "pk.eyJ1IjoiYnJvb2tlZnp5IiwiYSI6ImNqdWFtZHNmdTA0N3o0M21oZG9peDU2NXMifQ.fbFnwmA72jGPO8IHcfEeRA"
...
def update_graph(datasource):
    ...
    fig_temp.update_layout(
        ...
        mapbox=dict(
            ...
            style="mapbox://styles/brookefzy/cka1yguhe01of1jqharhr7bei",
            bearing=bearing,
            zoom=zoom,
        ),
        updatemenus=[
                            ...
                            args=[
                                {
                                    ...
                                    "mapbox.bearing": 0,
                                    "mapbox.style": "mapbox://styles/brookefzy/cka1yguhe01of1jqharhr7bei",
                                }
                            ],
                            label="Reset Zoom",
                            method="relayout",
